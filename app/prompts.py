...
Each bullet must be at most 110 characters. Cut filler words aggressively to stay under this limit.
Exception: "Arizona List — Data Analyst Intern" bullets may be up to 170 characters and may use all 4 bullets if JD-relevant.
Each project bullet must be at most 120 characters.
...
Each bullet must be at most 110 characters after compression.
...
Each project bullet must be at most 120 characters after compression.
